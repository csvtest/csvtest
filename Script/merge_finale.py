...
camera = numeri_in_nomi_zone(process_data('Politiche_Camera_Prova.csv'))
senato = numeri_in_nomi_zone(process_data('Politiche_Senato_Prova.csv'))
redditi = process_data('Redditi_nuova_media_2009-2016.csv')
residenti = process_data('censimento_intermedio.csv')

#merge_finale(redditi, camera, senato, residenti)

controllo_row(redditi, camera, senato)
controllo_colonne(redditi, camera, senato, residenti)
